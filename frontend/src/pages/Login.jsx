...
export default function Login() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      navigate(res.user.onboardingComplete ? '/dashboard' : '/onboarding');
    } catch {}
  };
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-bg-main to-bg-secondary">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-cta">Welcome back</h1>
        ...
        <div className="bg-bg-card rounded-card shadow-card p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs text-text-muted bg-bg-card px-3">or continue with</div>
          </div>
